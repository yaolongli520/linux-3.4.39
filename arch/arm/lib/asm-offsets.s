...
@ -mcpu=cortex-a9 -march=armv7-a -mno-unaligned-access -mfloat-abi=hard
@ -mfpu=vfpv3 -mtls-dialect=gnu -auxbase-strip arch/arm/lib/asm-offsets.s
@ -g -Os -Wall -Wstrict-prototypes -Wno-format-security
@ -Wno-format-nonliteral -Werror=date-time -Wno-unused-but-set-variable
@ -fno-builtin -ffreestanding -fno-stack-protector -fstack-usage
@ -ffunction-sections -fdata-sections -fno-common -ffixed-r9
@ -fno-short-enums -fstrict-aliasing -fverbose-asm
